...
data_arg.add_argument('--dataset', type=str, default='CityScapesDataset')
# CityScapesDataset
...
data_arg.add_argument(
    '--ade20k_path',
    type=str,
    default='/globalwork/yilmaz/data/raw/ADE20K',
    help='ADE20K dataset root dir')

data_arg.add_argument(
    '--cityscapes_path',
    type=str,
    default='/globalwork/data/cityscapes',
    help='CityScapes dataset root dir')

data_arg.add_argument(
    '--synapse_path',
    type=str,
    default='/globalwork/yilmaz/data/raw/Synapse',
    help='Synapse dataset root dir')
...
train_arg.add_argument('--test_stat_freq', type=int, default=400, help='print frequency')
